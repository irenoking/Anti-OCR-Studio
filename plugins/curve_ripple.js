...
window.AntiOcrPlugins.push({
    ...
    params: {
        macroAmplitude: { label: "宏观弯曲幅度", min: 0, max: 15, step: 0.5, value: 4.5 },
        microAmplitude: { label: "微观特征毛刺", min: 0, max: 4, step: 0.1, value: 1.2 },
        periodScale: { label: "波动周期密度", min: 10, max: 50, step: 1, value: 16 }
    },
