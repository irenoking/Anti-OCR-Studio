...
window.AntiOcrPlugins.push({
    ...
    // 暴露给前端可动态调参的元数据
    params: {
        lineCount: { label: "彩色干扰线条数", min: 0, max: 40, step: 1, value: 15 },
        lineWidth: { label: "线条物理粗度(px)", min: 1, max: 8, step: 1, value: 3 },
        shapeCount: { label: "几何斑块数量", min: 0, max: 20, step: 1, value: 8 },
        pointDensity: { label: "高频高对比噪点数", min: 0, max: 3000, step: 100, value: 800 }
    },
