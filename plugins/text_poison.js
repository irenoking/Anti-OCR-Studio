...
window.AntiOcrPlugins.push({
    ...
    params: {
        charCount: { label: "干扰字块总量", min: 0, max: 60, step: 1, value: 20 },
        fontSize: { label: "干扰字体大小(px)", min: 12, max: 24, step: 1, value: 16 },
        opacity: { label: "干扰字图层透明度", min: 0.1, max: 0.8, step: 0.05, value: 0.4 }
    },
